...
Если вы хотите подключить сторонние стили, добавьте их в объект paths, который описан в файле gulpfile.js (paths.csslibs), и выполните задачу `gulp csslibs`. Также раскомментируйте строку подключения стилей в src/jade/includes/head.jade.
...
Copyright (c) 2014-2015 [nikbelikov.ru](http://nikbelikov.ru/)
