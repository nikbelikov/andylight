...
После выкачивания всех зависимостей проекта и успешной первичной сборки, запустите задачу `gulp serve` и можете приступать к верстке.

## Что включено?

- синхронизируемый сервер (BrowserSync)
- компиляция jade и sass
- сжатие стилей, скриптов и изображений

### BrowserSync

Задача `gulp serve` откроет вкладку в браузере и в консоли вы увидите local и external пути до вашего проекта. Так, вы сможете отлаживать верстку сразу на нескольких устройствах.
